...
function populateRoundAnswers(gameQuestionIndexes, correctAnswerIndex, correctAnswerTargetLocation) {
    ...
    // Shuffle the answers, excluding the first service.
...
function handleAnswerRequest(intent, session, callback) {
    ...
    // Shuffle the answers, excluding the first aws service.
    for (var j = 1; j < answersCopy.length; j++){
        var rand = Math.floor(Math.random() * (index - 1)) + 1;
        index -= 1;
...
function handleAnswerRequest(intent, session, callback) {
    ...
    if (!gameInProgress) {
        ...
        var speechOutput = "Your answer must be a known A W S Service " + reprompt;
        ...
        if (currentQuestionIndex == GAME_LENGTH - 1) {
            ...
            speechOutput += speechOutputAnalysis + "You got " + currentScore.toString() + " out of "
                + GAME_LENGTH.toString() + " questions correct. Thank you for learning the A W S Services by D W K, W D Solutions with Alexa!";
            callback(session.attributes,
...
function handleGetHelpRequest(intent, session, callback) {
    ...
    var speechOutput = "I will ask you to provide the name of a, AWS Service. "
        + "For example, If I ask what service is can host Docker instances, you would say E C 2. To start a new game at any time, say, start new game. "
        + "To repeat the question, say, repeat. "
        + "Would you like to keep playing?",
        repromptText = "To give an answer, respond with the correct service. "
        + "Would you like to keep playing?";
